...
# 2. Cargar entorno y base de datos (con autogeneración si no existe y k=10 original)
@st.cache_resource
def inicializar_sistema_rag():
    ...
    # Verificación automática: Si no existe la BD local, la crea leyendo los PDFs de la carpeta data/actas
    db_path = "./chroma_db"
